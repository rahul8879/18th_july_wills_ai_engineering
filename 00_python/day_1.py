# python --> how we can build a sysyem using simple python
# name = True
# print(type(name)) # str
...
# print(sales_data[8]) # how we can access the elements using -->index
# print(sales_data[-2]) # how we can access the elements using -->index


# avg_odd_day_sales = sum(sales_data[0::2])/len(sales_data[0::2])
# avg_even_day_sales = sum(sales_data[1::2])/len(sales_data[1::2])
# print(round(avg_odd_day_sales, 2)) # how we can access the elements using -->slicing
# print(round(avg_even_day_sales, 2)) # how we can access the elements using -->slicing
